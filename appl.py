...
file1 = open(r'D:\\DATA_SCIENCE\\Python\\Assignment\\Logistic Regression\\pipe2.pkl', 'rb')
rf = pickle.load(file1)
file1.close()

data = pd.read_csv("D:\\DATA_SCIENCE\\Python\\Assignment\\Logistic Regression\\train_df_clean.csv")
